...
ROLE_ANSWERS = {
    "hannah": {
        1: "[한나] 답변 예시 (질문 1) - TODO: 그런 사람은 없습니다. 근대의 인간들은 자아가 녹아 없어지는 게 문제일 뿐, 결코 긍정성의 폭력에 시달리지 않습니다.",
        2: "[한나] 답변 예시 (질문 2) - TODO: 모르겠습니다.ㅠㅠ",
        3: "[한나] 답변 예시 (질문 3) - TODO: 근대사회는 인간을 노동하는 동물로 격하시키는 사회이다.",
        4: "[한나] 답변 예시 (질문 4) - TODO: 모르겠습니다.ㅠㅠ",
        5: "[한나] 답변 예시 (질문 5) - TODO: 활동적 삶은 부당하게 폄하되어 왔지만 사실 조급함을 넘어서는 무언가가 있다. 따라서 활동적 삶이 더 우위에 있다.",
        6: "[한나] 답변 예시 (질문 6) - TODO: 그들은 노동하는 동물로서, 자아를 놓고 오직 더 잘 일하는 것에만 몰두한다.",
    },
    "han_byung_chul": {
        1: "[한병철] 답변 예시 (질문 1) - TODO: 화해시키는 피로를 통해 피로사회 안에서 회복하세요.",
        2: "[한병철] 답변 예시 (질문 2) - TODO: 신경성 폭력의 결과 중 하나이다.",
        3: "[한병철] 답변 예시 (질문 3) - TODO: 현대사회는 규율사회에서 성과사회로 넘어간 단계이다.",
        4: "[한병철] 답변 예시 (질문 4) - TODO: 우울증의 원인은 후기근대적 노동사회의 새로운 계율이 된 성과주의의 명령이다. 또한 이것 말고도 사회의 원자화와 파편화로 인한 인간적 유대의 결핍도 있다. ",
        5: "[한병철] 답변 예시 (질문 5) - TODO: 사색적 삶이다. 사색적 삶은 멀티태스킹을 하고 있는 인간에게 모든 자극에 바로 반응하는 것을 멈출 수 있게 해주는 긍정적인 삶의 방식이다.",
        6: "[한병철] 답변 예시 (질문 6) - TODO: 그들은 성과주체로서 자신이 스스로를 착취하고, 긍정성의 폭력에 시달리는 인간들이다.",
    },
    "alain": {
        1: "[알랭] 답변 예시 (질문 1) - TODO: 줄 조언이 없습니다.ㅠㅠ",
        2: "[알랭] 답변 예시 (질문 2) - TODO: 자기 자신이 되지 못한 인간의 좌절에 대한 병리학적인 표현이다.",
        3: "[알랭] 답변 예시 (질문 3) - TODO: 현대사회는 아직 규율사회이거나 규율사회에서 막 넘어온 단계이며, 규율사회의 명령과 금지가 자기 책임과 주도로 대체될 때 우울증은 확산된다.",
        4: "[알랭] 답변 예시 (질문 4) - TODO: 자기 자신이 되어야 한다는 사회적 명령만이 우울증을 초래한다.",
        5: "[알랭] 답변 예시 (질문 5) - TODO: 모르겠습니다.ㅠㅠ",
        6: "[알랭] 답변 예시 (질문 6) - TODO: 니체의 주권적 인간과 동일하다. 이들에게 무엇이 되라고 요구할 수 있는 상위의 존재는 자기 자신밖에 없다.",
    }
}
